...
import { DisplayMode } from "./forms/genericPlanningForm";
import { GoalIndexCard } from "./indexcards/goalIndexCard";
...
export class CreateGoalsModal extends Modal {
    ...
    constructor(app: App, vault: Vault, settings: Settings, goalIndexCard: GoalIndexCard) {
		super(app);
        this._settings = settings;
        this._vault = vault;
        this.goalForm = new CreateGoalForm(DisplayMode.CREATE_MODE);
